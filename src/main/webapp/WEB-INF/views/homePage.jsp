        ...
        <div class="tab-content">
            <div id="aboutMe" class="tab-pane fade in active">
                <div class="col-sm-8">
                    ...
                    <p>Donec sed odio dui. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Vestibulum id ligula porta felis euismod semper. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa.</p>
                    <p><a href="#contact" class="btn btn-warning btn-lg">Get in Touch</a></p>
                </div>
                <div class="col-sm-4">
    ...
    <div class="container-fluid bg-grey">
        ...
        <div class="row">
            <div class="col-sm-5">
                ...
                <p><span class="glyphicon glyphicon-envelope"></span> <a href="mailto:tltmokgoatjane@gmail.com">tltmokgoatjane@gmail.com</a></p>
            </div>
            <div class="col-sm-7">
                <div class="row">
